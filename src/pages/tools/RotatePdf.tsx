    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4">Rotate PDF Pages</h1>
          <p className="text-muted-foreground text-center mb-8">
            Rotate PDF pages to the correct orientation. Fix upside-down or sideways pages easily.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p>Select pages and rotation angle</p>
                </div>
                <div className="flex gap-3">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p>✓ Rotate individual pages</p>
                <p>✓ Rotate all pages at once</p>
                <p>✓ 90°, 180°, 270° rotation</p>
