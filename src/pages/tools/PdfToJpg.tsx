    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-4">PDF to JPG Converter</h1>
          <p className="text-muted-foreground text-center mb-8">
            Convert PDF pages to high-quality JPG images. Perfect for presentations and web use.
          </p>
            ...
            <CardContent>
              <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-8 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Choose a PDF file to convert to JPG
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <p>Select image quality and resolution</p>
                </div>
                <div className="flex gap-3">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p>✓ Convert all pages to JPG</p>
                <p>✓ High-quality image output</p>
                <p>✓ Customizable resolution</p>
